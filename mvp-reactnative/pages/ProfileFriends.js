      ...
      <ScrollView style={styles.container}>
        ...
        <View style={styles.networkInfo}>
          <View style={styles.networkTitle}>
            <View>
              <Text style={ styles.networkTxt }>
                Your network:
                <Text style={ styles.nbrTxt }>122</Text>
              </Text>
              <Text style={ styles.membersTxt }>(Members met)</Text>
            </View>
            <CheckBox
          ...
          <View style={styles.cardContainer}>
            ...
            <Image style={styles.avatarLiked} source={require("../assets/images/randomUser.png")}/>
          ...
          <View>
            <TouchableOpacity>
              <Previous style={styles.previousRight} />
            </TouchableOpacity>
            <TouchableOpacity>
              <Previous style={styles.previousLeft} />
            </TouchableOpacity>
          </View>
          {/* End previous btn */}
        </View>
        ...
        <View style={styles.likedBigContainer}>
          <View style={styles.title}>
            <Text style={ styles.membersTxt }>(Private list)</Text>
            <Text style={ styles.likedTxt }>
              User Liked:
              <Text style={ styles.nbrTxt }>12</Text>
            </Text>
            <TouchableOpacity style={styles.publicBtn}>
              <Text style={styles.seeText}>See all</Text>
            </TouchableOpacity>
