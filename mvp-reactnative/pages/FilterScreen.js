...
const FilterScreen = () => {
  ...
  return (
    <ScrollView style={[styles.container]}>
      <DateField title={"Choose a Date"} state={date} setState={setDate} style={styles.fields}/>
      <View style={styles.fields}>
        <Text style={styles.boldTitle}>{filter.radius}</Text>
        <OneValueSlider minVal={1} maxVal={100} state={nbKms} setState={setNbKms}/>
      </View>
      <View style={styles.fields}>
        ...
        <View style={styles.fields}>
          <SelectList setSelected={setSelected} data={data} style={styles.margin}/>
        </View>
      </View>
      <View style={styles.fields}>
      ...
      <View style={styles.fields}>
        ...
        <View style={styles.row}>
          ...
          <CheckboxSquare title={"With people I already met"} state={state}setState={setState}/>
        </View>
      </View>
      <View style={styles.fields}>
        <Text style={styles.boldTitle}>
      ...
      <View style={styles.dButton}>
        <TouchableOpacity onPress={handlePress} style={selected1 === true ? styles.leftButtonSelected : styles.leftButton}>
          <Text style={selected1 === true ? styles.boldTextSelected : styles.boldText}>
            {/*🇫🇷 La variable filter.past dans fr.json permet d'afficher "Evénement passé"*/}
            {/*🇬🇧 The en.json filter.past displays "Past events"*/}
            {filter.past}
          </Text>
        </TouchableOpacity>
        <TouchableOpacity onPress={handlePress2} style={selected2 === true ? styles.rightButtonSelected : styles.rightButton}>
          <Text style={selected2 === true ? styles.boldTextSelected : styles.boldText}>
            {filter.next}
          </Text>
        </TouchableOpacity>
      </View>
      <TouchableOpacity style={selected1 === true || selected2 === true ? styles.buttonActive : styles.button}>
