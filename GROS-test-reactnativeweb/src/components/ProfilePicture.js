  ...
  return (
    <>
      ...
      <View style={styles.imgContainer}>
        {!avatarImage ? (
          <Image source={DefaultPicture} style={{ width: 120, height: 120 }} />
        ) : (
      ...
      <Text style={ styles.uploadErrorMsgTxt }>
        {uploadErrorMessage}
      </Text>
      ...
      {!!completedCrop && (
        <canvas
          ...
          style={[ styles.canvasStyle, { width: completedCrop.width, height: completedCrop.height}]}
        />
      )}
    </>
  );
